        ...
        it("displays spinner while api request is in progress",
         async () => {
            ...
            async () => {
               ...
               await setup()
               const button = screen.getByRole("button", { name: "Sign Up"}) 
               const text = await screen.queryByText("Please check your e-mail to activate your acount")
            ...
            const text = await screen.findByText("Please check your e-mail to activate your acount")
            ...
            const text = screen.queryByText("Please check your e-mail to activate your acount")
            expect(text).not.toBeInTheDocument()
